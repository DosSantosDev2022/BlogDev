...
export default function Banners() {
  return (
    <Link href={''}>
      <div  className=" relative flex items-end bg-contain bg-no-repeat bg-center bg-[url('/banner.png')] w-[46.5rem] h-[24.75rem] ">
        <div className=" absolute bottom-14 left-16 flex flex-col gap-1 items-start">
